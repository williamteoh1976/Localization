...
## [](https://docs.microsoft.com/zh-tw/learn/paths/dyn-power-plat-bus-app-fundamentals)
####  -  - 
...
## [Use basic formulas to make better PowerApps canvas apps](https://docs.microsoft.com/zh-tw/learn/paths/use-basic-formulas-powerapps-canvas-app)
...
## [Explore AI solution development with data science services in Azure](https://docs.microsoft.com/zh-tw/learn/paths/explore-data-science-tools-in-azure)
...
## [Work with data in a PowerApps canvas app](https://docs.microsoft.com/zh-tw/learn/paths/work-with-data-in-a-canvas-app)
...
## [Build AI solutions with Azure Machine Learning service](https://docs.microsoft.com/zh-tw/learn/paths/build-ai-solutions-with-azure-ml-service)
#### 學習途徑 - 2 小時 50 分鐘 - 單元數：4
...
## [Get started with Machine Learning with an Azure Data Science Virtual Machine](https://docs.microsoft.com/zh-tw/learn/paths/get-started-with-azure-dsvm)
#### 學習途徑 - 1 小時 20 分鐘 - 單元數：3
...
## [Introduction to machine learning with Python and Azure Notebooks](https://docs.microsoft.com/zh-tw/learn/paths/intro-to-ml-with-python)
...
## [Administer containers in Azure](https://docs.microsoft.com/zh-tw/learn/paths/administer-containers-in-azure)
#### 學習途徑 - 1 小時 37 分鐘 - 單元數：2
...
## [Evaluate text with Azure Cognitive Language Services](https://docs.microsoft.com/zh-tw/learn/paths/evaluate-text-with-language-services)
...
## [Process and translate speech with Azure Cognitive Speech Services](https://docs.microsoft.com/zh-tw/learn/paths/translate-speech-with-speech-services)
...
## [Create Intelligent Bots with the Azure Bot Service](https://docs.microsoft.com/zh-tw/learn/paths/create-bots-with-the-azure-bot-service)
#### 學習途徑 - 2 小時 38 分鐘 - 單元數：2
Learn how to build a chat bot and add intelligence to the Bot by integrating QnA Maker and LUIS.

## [Publish a Machine Learning Experiment with Microsoft Azure Machine Learning Studio](https://docs.microsoft.com/zh-tw/learn/paths/publish-experiment-with-ml-studio)
...
## [Process and classify images with the Azure Cognitive Vision Services](https://docs.microsoft.com/zh-tw/learn/paths/classify-images-with-vision-services)
...
## [Perform data Engineering with Azure Databricks](https://docs.microsoft.com/zh-tw/learn/paths/modern-data-warehouse)
...
## [Automate a business process using Microsoft Flow](https://docs.microsoft.com/zh-tw/learn/paths/automate-process-using-flow)
...
## [Create a canvas app in PowerApps](https://docs.microsoft.com/zh-tw/learn/paths/create-powerapps)
#### 學習途徑 - 2 小時 16 分鐘 - 單元數：3
This learning path introduces you to PowerApps, helps you create and customize an app, and then manage and distribute it.

## [Create a model-driven application in PowerApps](https://docs.microsoft.com/zh-tw/learn/paths/create-app-models-business-processes)
#### 學習途徑 - 1 小時 40 分鐘 - 單元數：2
...
## [Create and use analytics reports with Power BI](https://docs.microsoft.com/zh-tw/learn/paths/create-use-analytics-reports-power-bi)
...
## [Implement a Data Streaming Solution with Azure Streaming Analytics](https://docs.microsoft.com/zh-tw/learn/paths/implement-data-streaming-with-asa)
...
## [Implement a Data Warehouse with Azure SQL Data Warehouse](https://docs.microsoft.com/zh-tw/learn/paths/implement-sql-data-warehouse)
...
## [Azure for the Data Engineer](https://docs.microsoft.com/zh-tw/learn/paths/azure-for-the-data-engineer)
...
## [Large Scale Data Processing with Azure Data Lake Storage Gen2](https://docs.microsoft.com/zh-tw/learn/paths/data-processing-with-azure-adls)
#### 學習途徑 - 2 小時 5 分鐘 - 單元數：3
...
## [Extract knowledge and insights from your data with Azure Databricks](https://docs.microsoft.com/zh-tw/learn/paths/data-science)
...
## [Azure fundamentals](https://docs.microsoft.com/zh-tw/learn/paths/azure-fundamentals)
...
## [Develop Windows 10 applications](https://docs.microsoft.com/zh-tw/learn/paths/develop-windows10-apps)
#### 學習途徑 - 4 小時 30 分鐘 - 單元數：4
Learn how to develop, test, and deploy Windows 10 applications.

## [Work with NoSQL data in Azure Cosmos DB](https://docs.microsoft.com/zh-tw/learn/paths/work-with-nosql-data-in-azure-cosmos-db)
#### 學習途徑 - 2 小時 27 分鐘 - 單元數：4
...
## [Administer infrastructure resources in Azure](https://docs.microsoft.com/zh-tw/learn/paths/administer-infrastructure-resources-in-azure)
#### 學習途徑 - 9 小時 29 分鐘 - 單元數：10
Learn how to create, manage, secure and scale virtual machine resources.

## [Work with relational data in Azure](https://docs.microsoft.com/zh-tw/learn/paths/work-with-relational-data-in-azure)
#### 學習途徑 - 1 小時 34 分鐘 - 單元數：2
...
## [Deploy a website to Azure with Azure App Service](https://docs.microsoft.com/zh-tw/learn/paths/deploy-a-website-with-azure-app-service)
#### 學習途徑 - 3 小時 - 單元數：3
...
## [Manage resources in Azure](https://docs.microsoft.com/zh-tw/learn/paths/manage-resources-in-azure)
#### 學習途徑 - 3 小時 29 分鐘 - 單元數：4
Learn how to work with the Azure command line and web portal to create, manage, and control cloud based resources.

## [Create serverless applications](https://docs.microsoft.com/zh-tw/learn/paths/create-serverless-applications)
...
## [Connect your services together](https://docs.microsoft.com/zh-tw/learn/paths/connect-your-services-together)
#### 學習途徑 - 3 小時 33 分鐘 - 單元數：4
...
## [Architect great solutions in Azure](https://docs.microsoft.com/zh-tw/learn/paths/architect-great-solutions-in-azure)
...
## [Deploy a website with Azure virtual machines](https://docs.microsoft.com/zh-tw/learn/paths/deploy-a-website-with-azure-virtual-machines)
#### 學習途徑 - 4 小時 13 分鐘 - 單元數：4
...
## [Secure your cloud data](https://docs.microsoft.com/zh-tw/learn/paths/secure-your-cloud-data)
...
## [Store data in Azure](https://docs.microsoft.com/zh-tw/learn/paths/store-data-in-azure)
