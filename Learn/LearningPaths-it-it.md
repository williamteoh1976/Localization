...
## [Identificare i principi per un'implementazione responsabile dell'intelligenza artificiale in enti pubblici](https://docs.microsoft.com/it-it/learn/paths/responsible-ai-government-principles)
#### Percorso di apprendimento - 1 h 56 min - 3 Moduli
È fondamentale riflettere sulle implicazioni dell'intelligenza artificiale nell'ambito di enti pubblici. Questo percorso di apprendimento include linee guida per la configurazione di principi base e di un modello di governance all'interno di un'organizzazione pubblica. Verranno anche presentati risorse, procedure consigliate e strumenti.
...
#### Percorso di apprendimento - 2 h 21 min - 4 Moduli
...
#### Percorso di apprendimento - 3 h 18 min - 5 Moduli
...
#### Percorso di apprendimento - 2 h 28 min - 4 Moduli
...
#### Percorso di apprendimento - 6 h 22 min - 6 Moduli
...
#### Percorso di apprendimento - 3 h 45 min - 5 Moduli
...
#### Percorso di apprendimento - 6 h 10 min - 7 Moduli
Azure DevOps consente di compilare, testare e distribuire qualsiasi applicazione in qualsiasi cloud o in locale. Informazioni su come configurare pipeline di compilazione in grado di compilare, testare e verificare le applicazioni in modo continuo.
Contenuto del percorso di apprendimento:

Collaborare con altri utenti per compilare le applicazioni tramite Azure Pipelines e GitHub
Eseguire test automatizzati nella pipeline per convalidare la qualità del codice
Eseguire l'analisi del codice sorgente e dei componenti di terze parti per rilevare potenziali vulnerabilità
Definire più pipeline che interagiscano per eseguire la compilazione dell'applicazione
Compilare applicazioni usando sia agenti ospitati da Microsoft che gli agenti di compilazione personalizzati
...
#### Percorso di apprendimento - 1 h 17 min - 3 Moduli
...
In questo percorso di apprendimento si inizierà il viaggio nel mondo DevOps. Contenuto del modulo:

Vedere in che modo le mappe di flusso dei valori consentono di valutare i processi e le tecnologie correnti
Iscriversi per ricevere un account Azure DevOps gratuito
Apprendere come pianificare e tenere traccia degli elementi di lavoro tramite Azure Boards
...
#### Percorso di apprendimento - 8 h 40 min - 12 Moduli
...
#### Percorso di apprendimento - 2 h 11 min - 3 Moduli
...
#### Percorso di apprendimento - 7 h 25 min - 8 Moduli
...
#### Percorso di apprendimento - 9 h 34 min - 10 Moduli
...
#### Percorso di apprendimento - 2 h 9 min - 2 Moduli
...
#### Percorso di apprendimento - 1 h 25 min - 2 Moduli
...
## [Business school di intelligenza artificiale per l'istruzione](https://docs.microsoft.com/it-it/learn/paths/ai-business-school-education)
#### Percorso di apprendimento - 8 h 37 min - 12 Moduli
I responsabili del settore dell'istruzione devono analizzare gli aspetti specifici del settore, per comprendere l'effetto di trasformazione reale dell'intelligenza artificiale nel settore dell'istruzione. È essenziale comprendere gli elementi di una strategia che assisterà il settore dell'istruzione nella creazione di valore tramite l'intelligenza artificiale. Questo percorso di apprendimento è progettato per i decision maker nel settore dell'istruzione e illustra l'effetto di trasformazione reale dell'intelligenza artificiale nel settore dell'istruzione.
...
#### Percorso di apprendimento - 4 h 43 min - 6 Moduli
...
#### Percorso di apprendimento - 8 h 27 min - 12 Moduli
...
#### Percorso di apprendimento - 3 h 22 min - 5 Moduli
...
## [Identificare i principi per un'implementazione responsabile dell'intelligenza artificiale](https://docs.microsoft.com/it-it/learn/paths/responsible-ai-business-principles)
#### Percorso di apprendimento - 1 h 49 min - 3 Moduli
È fondamentale riflettere sulle implicazioni dell'intelligenza artificiale nell'ambito dell'azienda. Questo percorso di apprendimento include linee guida per la configurazione di principi base e di un modello di governance all'interno di un'organizzazione. Verranno anche presentati risorse, procedure consigliate e strumenti.
...
#### Percorso di apprendimento - 8 h 26 min - 12 Moduli
...
#### Percorso di apprendimento - 8 h 31 min - 12 Moduli
...
## [Usare tecniche avanzate per le app canvas di PowerApps](https://docs.microsoft.com/it-it/learn/paths/understand-advanced-topics)
#### Percorso di apprendimento - 2 h 30 min - 4 Moduli
...
#### Percorso di apprendimento - 1 h 58 min - 3 Moduli
...
#### Percorso di apprendimento - 2 h 14 min - 3 Moduli
...
#### Percorso di apprendimento - 3 h 17 min - 4 Moduli
...
#### Percorso di apprendimento - 1 h 43 min - 3 Moduli
...
#### Percorso di apprendimento - 2 h 38 min - 2 Moduli
I bot consentono ai clienti di interagire con le applicazioni su computer dialogando tramite testo, grafica o voce. Può trattarsi di un dialogo fatto di domande e risposte o di un bot sofisticato, che consente agli utenti di interagire con i servizi in modo intelligente tramite criteri di ricerca, rilevamento dello stato e tecniche di intelligenza artificiale ben integrate con i servizi di business esistenti.  Informazioni su come compilare un chat bot e aggiungere intelligenza al bot integrando QnA Maker e LUIS.
...
Machine Learning svolge un ruolo importante nelle applicazioni che sfruttano l'intelligenza artificiale. Machine Learning Studio e Machine Learning Services di Microsoft facilitano l'utilizzo dei modelli predefiniti e la creazione di modelli di Machine Learning personalizzati. Informazioni su come creare un account in Azure Machine Learning Studio, creare un esperimento di esempio e quindi pubblicare e distribuire l'esperimento per l'utilizzo come servizio Web.
...
#### Percorso di apprendimento - 2 h 45 min - 4 Moduli
...
Servizi cognitivi Microsoft offre funzionalità per abilitare i servizi di riconoscimento vocale nelle applicazioni. Informazioni su come convertire la voce in testo e riconoscere parlanti specifici nelle applicazioni grazie all'integrazione dei servizi di riconoscimento vocale dei servizi cognitivi.
...
#### Percorso di apprendimento - 7 h 49 min - 9 Moduli
Di seguito viene descritto come usare Azure Databricks per accelerare la configurazione di Databricks in Azure. Si useranno i dati in un'istanza di Azure SQL Data Warehouse con i servizi connettore predefiniti. Si esploreranno i servizi dati disponibili con Azure Data Factory. Si creeranno flussi di lavoro semplificati e si userà l'area di lavoro di analisi interattiva supportata da Apache Spark.
...
#### Percorso di apprendimento - 4 h 58 min - 9 Moduli
Si è interessati a conoscere il cloud tramite informazioni di facile comprensione? O forse non si sa da dove iniziare con la tecnologia cloud?
Questa esperienza di apprendimento include un percorso che inizierà mostrando come la trasformazione digitale e la potenza del cloud possono trasformare la propria attività. Verrà trattato il modo in cui i servizi cloud di Microsoft Azure possono conferire maggiore potere alla propria organizzazione in una piattaforma cloud attendibile. Infine, verrà illustrato come applicare concretamente questo percorso per la propria organizzazione.
Questo percorso di apprendimento consente di acquisire informazioni riguardo a:

Abilitazione della trasformazione digitale.
Identificazione dei modi per eseguire la migrazione e modernizzare le applicazioni.
Ottenere informazioni dettagliate sui dati, l'intelligenza artificiale (AI) e Internet delle cose (IoT)
Trovare un'ampia gamma di standard normativi e di conformità in una piattaforma cloud attendibile.
...
Questo percorso di apprendimento consente di:

Apprendere come creare un'istanza di Azure SQL Data Warehouse
Eseguire query e visualizzare dati da Azure SQL Data Warehouse
Importare dati in Azure SQL Data Warehouse tramite PolyBase
Comprendere i controlli di sicurezza disponibili con Archiviazione di Azure e Azure SQL Data Warehouse
...
#### Percorso di apprendimento - 4 h 21 min - 6 Moduli
...
#### Percorso di apprendimento - 9 h 35 min - 12 Moduli
...
Apprendere alcuni concetti chiave del cloud, tra cui disponibilità elevata, scalabilità, elasticità, agilità, tolleranza di errore e ripristino di emergenza
Comprendere i vantaggi del cloud computing in Azure e come questo consente di risparmiare tempo e denaro
Confrontare strategie di base per la transizione al cloud di Azure
Esplorare la portata dei servizi disponibili in Azure, tra cui elaborazione, rete, archiviazione e protezione

Dopo aver completato questo percorso di apprendimento, si avranno le conoscenze necessarie per affrontare l'Esame AZ900 - Fondamenti di Microsoft Azure.
...
#### Percorso di apprendimento - 7 h 10 min - 8 Moduli
...
#### Percorso di apprendimento - 4 h 36 min - 6 Moduli
...
#### Percorso di apprendimento - 3 h 31 min - 4 Moduli
...
#### Percorso di apprendimento - 5 h 55 min - 8 Moduli
...
#### Percorso di apprendimento - 4 h 10 min - 5 Moduli
...
#### Percorso di apprendimento - 9 h 22 min - 10 Moduli
...
#### Percorso di apprendimento - 4 h 6 min - 4 Moduli
...
#### Percorso di apprendimento - 6 h 45 min - 8 Moduli
...
#### Percorso di apprendimento - 4 h 15 min - 5 Moduli
...
## [Get started with Trade in Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/it-it/learn/modules/trade-get-started-dynamics-365-business-central)
...
## [Prepare to complete the Project Specialist Technical Achievement](https://docs.microsoft.com/it-it/learn/paths/project-specialist-technical-achievement)
...
## [Get started with Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/it-it/learn/paths/get-started-dynamics-365-business-central)
...
## [Process VAT in Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/it-it/learn/paths/process-vat-dynamics-365-business-central)
...
## [Post sales and purchase invoices in Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/it-it/learn/paths/post-sales-purchase-invoices-dynamics-365-business-central)
...
## [Use journals in Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/it-it/learn/paths/use-journals-dynamics-365-business-central)
...
## [Create relationships, business rules, calculations, and rollups in Common Data Service](https://docs.microsoft.com/it-it/learn/paths/create-relationships-common-data-service)
...
## [Microsoft 365 - Modernize your enterprise deployment with Windows 10 and Office 365 ProPlus](https://docs.microsoft.com/it-it/learn/paths/m365-getmodern)
...
## [Configure and manage products and inventory in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/it-it/learn/paths/configure-manage-products-inventory-dyn365-supply-chain-mgmt)
...
## [Configure and use process manufacturing in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/it-it/learn/paths/configure-use-process-manufacturing-dyn365-supply-chain-mgmt)
...
## [Configure and use budgeting in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/it-it/learn/paths/configure-use-budgeting-dyn365-finance)
...
## [Use Lifecycle Services (LCS) to design and plan an implementation of Dynamics 365 for Finance and Operations](https://docs.microsoft.com/it-it/learn/paths/use-lcs-design-plan-implementation-finance-operations)
