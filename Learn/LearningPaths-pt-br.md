...
Este roteiro de aprendizagem apresenta a criação de um PowerApp controlado por modelo que usa o Common Data Service para Aplicativos.
...
## [Processamento de dados de grande escala com o Azure Data Lake Storage G2](https://docs.microsoft.com/pt-br/learn/paths/data-processing-with-azure-adls)
#### Roteiro de aprendizagem - 2 h 4 min - 3 módulos
Neste roteiro de aprendizagem, você verá como o Azure Data Lake Storage pode acelerar o processamento de soluções analíticas de Big Data e quão fácil é sua configuração. Você também vai explorar como ele se encaixa nas arquiteturas comuns, bem como os diferentes métodos de upload de dados para o armazenamento de dados. Por fim, você examinará a infinidade de recursos de segurança que garantirão que seus dados estejam seguros.
...
#### Roteiro de aprendizagem - 2 h 0 min - 2 módulos
...
#### Roteiro de aprendizagem - 3 h 0 min - 3 módulos
...
#### Roteiro de aprendizagem - 9 h 25 min - 10 módulos
...
## [Modern data warehouse](https://docs.microsoft.com/pt-br/learn/paths/modern-data-warehouse)
#### Roteiro de aprendizagem - 14 h 34 min - 9 módulos
Learn the moder data warehousing tools and techniques supported by Azure Databricks.
...
## [Data science](https://docs.microsoft.com/pt-br/learn/paths/data-science)
#### Roteiro de aprendizagem - 4 h 53 min - 5 módulos
