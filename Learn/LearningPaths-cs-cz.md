...
## [Use the UI and controls in a canvas app in PowerApps](https://docs.microsoft.com/cs-cz/learn/paths/ui-controls-canvas-app-powerapps)
...
## [](https://docs.microsoft.com/cs-cz/learn/paths/dyn-power-plat-bus-app-fundamentals)
####  -  - 
...
#### Plán výuky - 4 hod 29 min - Počet modulů: 5
...
## [Configure and use the General ledger in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/cs-cz/learn/paths/configure-use-general-ledger-dynamics-365-finance-ops)
...
## [Use basic formulas to make better PowerApps canvas apps](https://docs.microsoft.com/cs-cz/learn/paths/use-basic-formulas-powerapps-canvas-app)
...
## [Get started with Machine Learning with an Azure Data Science Virtual Machine](https://docs.microsoft.com/cs-cz/learn/paths/get-started-with-azure-dsvm)
#### Plán výuky - 1 hod 20 min - Počet modulů: 3
...
## [Build AI solutions with Azure Machine Learning service](https://docs.microsoft.com/cs-cz/learn/paths/build-ai-solutions-with-azure-ml-service)
#### Plán výuky - 2 hod 50 min - Počet modulů: 4
...
## [Explore AI solution development with data science services in Azure](https://docs.microsoft.com/cs-cz/learn/paths/explore-data-science-tools-in-azure)
...
## [Introduction to machine learning with Python and Azure Notebooks](https://docs.microsoft.com/cs-cz/learn/paths/intro-to-ml-with-python)
...
## [Work with data in a PowerApps canvas app](https://docs.microsoft.com/cs-cz/learn/paths/work-with-data-in-a-canvas-app)
...
## [Administer containers in Azure](https://docs.microsoft.com/cs-cz/learn/paths/administer-containers-in-azure)
...
## [Create Intelligent Bots with the Azure Bot Service](https://docs.microsoft.com/cs-cz/learn/paths/create-bots-with-the-azure-bot-service)
...
## [Process and translate speech with Azure Cognitive Speech Services](https://docs.microsoft.com/cs-cz/learn/paths/translate-speech-with-speech-services)
...
## [Process and classify images with the Azure Cognitive Vision Services](https://docs.microsoft.com/cs-cz/learn/paths/classify-images-with-vision-services)
...
## [Publish a Machine Learning Experiment with Microsoft Azure Machine Learning Studio](https://docs.microsoft.com/cs-cz/learn/paths/publish-experiment-with-ml-studio)
...
## [Evaluate text with Azure Cognitive Language Services](https://docs.microsoft.com/cs-cz/learn/paths/evaluate-text-with-language-services)
...
## [Perform data Engineering with Azure Databricks](https://docs.microsoft.com/cs-cz/learn/paths/modern-data-warehouse)
#### Plán výuky - 10 hod 23 min - Počet modulů: 9
Learn the modern data warehousing tools and techniques supported by Azure Databricks.
...
## [Automate a business process using Microsoft Flow](https://docs.microsoft.com/cs-cz/learn/paths/automate-process-using-flow)
...
## [Create a canvas app in PowerApps](https://docs.microsoft.com/cs-cz/learn/paths/create-powerapps)
#### Plán výuky - 2 hod 16 min - Počet modulů: 3
...
## [Create and use analytics reports with Power BI](https://docs.microsoft.com/cs-cz/learn/paths/create-use-analytics-reports-power-bi)
...
## [Create a model-driven application in PowerApps](https://docs.microsoft.com/cs-cz/learn/paths/create-app-models-business-processes)
#### Plán výuky - 1 hod 40 min - Počet modulů: 2
This learning path introduces you to creating a model-driven PowerApp that uses the Common Data Service for Apps.
...
## [Azure for the Data Engineer](https://docs.microsoft.com/cs-cz/learn/paths/azure-for-the-data-engineer)
...
## [Large Scale Data Processing with Azure Data Lake Storage Gen2](https://docs.microsoft.com/cs-cz/learn/paths/data-processing-with-azure-adls)
#### Plán výuky - 2 hod 5 min - Počet modulů: 3
...
#### Plán výuky - 4 hod 46 min - Počet modulů: 15
...
## [Implement a Data Streaming Solution with Azure Streaming Analytics](https://docs.microsoft.com/cs-cz/learn/paths/implement-data-streaming-with-asa)
...
## [Implement a Data Warehouse with Azure SQL Data Warehouse](https://docs.microsoft.com/cs-cz/learn/paths/implement-sql-data-warehouse)
...
## [Extract knowledge and insights from your data with Azure Databricks](https://docs.microsoft.com/cs-cz/learn/paths/data-science)
...
## [Azure fundamentals](https://docs.microsoft.com/cs-cz/learn/paths/azure-fundamentals)
...
## [Connect your services together](https://docs.microsoft.com/cs-cz/learn/paths/connect-your-services-together)
...
## [Deploy a website with Azure virtual machines](https://docs.microsoft.com/cs-cz/learn/paths/deploy-a-website-with-azure-virtual-machines)
...
## [Secure your cloud data](https://docs.microsoft.com/cs-cz/learn/paths/secure-your-cloud-data)
...
## [Work with relational data in Azure](https://docs.microsoft.com/cs-cz/learn/paths/work-with-relational-data-in-azure)
#### Plán výuky - 1 hod 34 min - Počet modulů: 2
...
## [Deploy a website to Azure with Azure App Service](https://docs.microsoft.com/cs-cz/learn/paths/deploy-a-website-with-azure-app-service)
...
## [Work with NoSQL data in Azure Cosmos DB](https://docs.microsoft.com/cs-cz/learn/paths/work-with-nosql-data-in-azure-cosmos-db)
...
## [Administer infrastructure resources in Azure](https://docs.microsoft.com/cs-cz/learn/paths/administer-infrastructure-resources-in-azure)
#### Plán výuky - 9 hod 29 min - Počet modulů: 10
Learn how to create, manage, secure and scale virtual machine resources.

## [Architect great solutions in Azure](https://docs.microsoft.com/cs-cz/learn/paths/architect-great-solutions-in-azure)
...
## [Create serverless applications](https://docs.microsoft.com/cs-cz/learn/paths/create-serverless-applications)
...
## [Manage resources in Azure](https://docs.microsoft.com/cs-cz/learn/paths/manage-resources-in-azure)
...
## [Store data in Azure](https://docs.microsoft.com/cs-cz/learn/paths/store-data-in-azure)
