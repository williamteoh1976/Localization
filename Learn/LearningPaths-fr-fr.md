...
Découvrez les outils et techniques modernes d’entreposage de données pris en charge par Azure Databricks.
...
Ce parcours d’apprentissage vous présente la création d’une application PowerApp basée sur des modèles qui utilise Common Data Service for Apps.
...
#### Parcours d’apprentissage - 8 heure(s) 52 minute(s) - 8 modules
