...
## [Speciális adatbeállítások és összekötők használata a PowerAppsben](https://docs.microsoft.com/hu-hu/learn/paths/advanced-data-options-and-connectors)
...
## [Adatok használata a Power BI-jal](https://docs.microsoft.com/hu-hu/learn/paths/consume-data-with-power-bi)
...
## [Mesterfogások PowerApps-vászonalkalmazásokhoz](https://docs.microsoft.com/hu-hu/learn/paths/understand-advanced-topics)
...
## [Adatstreamelési megoldás implementálása az Azure Stream Analytics szolgáltatással](https://docs.microsoft.com/hu-hu/learn/paths/implement-data-streaming-with-asa)
...
#### Képzési terv - 9 óra 35 perc - Modulok száma: 12
...
- Alapszintű Cloud Services – Az Azure bemutatása
...
#### Képzési terv - 7 óra 10 perc - Modulok száma: 8
...
Modules:
- Az üzleti folyamatok automatizálására leginkább megfelelő Azure-szolgáltatás kiválasztása
...
- Kövesse nyomon a GitHub-eseményeket az Azure Functions által kínált webhookokkal
- Automatikus frissítések engedélyezése webalkalmazásban az Azure Functions és a SignalR Service használatával
...
#### Képzési terv - 9 óra 22 perc - Modulok száma: 10
...
#### Képzési terv - 4 óra 6 perc - Modulok száma: 4
...
#### Képzési terv - 4 óra 10 perc - Modulok száma: 5
...
- Az Azure SQL Database-adatbázis védelme
- Azure SQL-adatbázist lekérdező ASP.NET-alkalmazás fejlesztése és konfigurálása
...
## [Process financial periodic activities in Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/hu-hu/learn/paths/process-financial-periodic-activities-dynamics-365-business-central)
#### Képzési terv - 3 óra 3 perc - Modulok száma: 4
...
## [Use multiple currencies in Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/hu-hu/learn/paths/use-multiple-currencies-dynamics-365-business-central)
#### Képzési terv - 3 óra 4 perc - Modulok száma: 5
...
## [Post sales and purchase invoices in Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/hu-hu/learn/paths/post-sales-purchase-invoices-dynamics-365-business-central)
#### Képzési terv - 3 óra 44 perc - Modulok száma: 5
...
## [Deliver remote desktops and apps from Azure with Windows Virtual Desktop](https://docs.microsoft.com/hu-hu/learn/paths/m365-wvd)
#### Képzési terv - 1 óra 47 perc - Modulok száma: 4
...
## [Process customer and vendor payments in Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/hu-hu/learn/paths/process-customer-vendor-payments-dynamics-365-business-central)
#### Képzési terv - 2 óra 36 perc - Modulok száma: 4
...
## [Use cost accounting in Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/hu-hu/learn/paths/use-cost-accounting-dynamics-365-business-central)
#### Képzési terv - 3 óra 16 perc - Modulok száma: 5
...
## [Create financial reports in Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/hu-hu/learn/paths/create-financial-reports-dynamics-365-business-central)
#### Képzési terv - 3 óra 44 perc - Modulok száma: 5
...
## [Reconcile bank accounts in Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/hu-hu/learn/paths/reconcile-bank-accounts-dynamics-365-business-central)
#### Képzési terv - 1 óra 38 perc - Modulok száma: 3
...
## [Manage team collaboration with Microsoft Teams](https://docs.microsoft.com/hu-hu/learn/paths/m365-manage-team-collaboration)
#### Képzési terv - 2 óra 17 perc - Modulok száma: 5
...
## [Building Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/build-finance-operations)
...
## [Manage permissions and administration for Common Data Service](https://docs.microsoft.com/hu-hu/learn/paths/manage-permissions-administration-common-data-service)
...
## [Connect to Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/connect-finance-operations)
...
## [Introduction to developing with Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/introduction-develop-finance-operations)
...
## [Extending Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/extending-finance-operations)
...
## [Use warehouse management in manufacturing in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/use-warehouse-manufacturing-dyn365-supply-chain-mgmt)
...
## [Configure and manage products and inventory in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/configure-manage-products-inventory-dyn365-supply-chain-mgmt)
...
## [Configure and manage procurement and vendors in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/configure-manage-procurement-vendors-dyn365-supply-chain-mgmt)
...
## [Configure and work with warehouse management in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/configure-work-warehouse-management-dyn365-supply-chain-mgmt)
...
## [Configure and use discrete manufacturing in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/configure-use-discrete-manufacturing-dyn365-supply-chain-mgmt)
...
## [Configure and use lean manufacturing in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/configure-use-lean-manufacturing-dyn365-supply-chain-mgmt)
...
## [Configure and use process manufacturing in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/configure-use-process-manufacturing-dyn365-supply-chain-mgmt)
...
## [Configure and manage fixed assets in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/configure-manage-fixed-assets-dyn365-finance)
...
## [Configure and use budgeting in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/configure-use-budgeting-dyn365-finance)
...
## [Configure and use cash and bank management, and sales tax in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/configure-use-cash-bank-management-tax-dyn365-finance)
...
## [Work with accounts receivable in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/work-accounts-receivable-dyn365-finance)
...
## [Migrate data and go live with Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/migrate-data-go-live-finance-operations)
...
## [Configure and use the General ledger in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/configure-use-general-ledger-dyn365-finance)
...
## [Configure your organization in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/configure-your-organization-finance-ops)
...
## [Work with accounts payable in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/work-accounts-payable-dyn365-finance)
...
## [Use Lifecycle Services (LCS) to design and plan an implementation of Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/use-lcs-design-plan-implementation-finance-operations)
...
## [Implementing Dynamics 365 Customer Engagement Online](https://docs.microsoft.com/hu-hu/learn/paths/implementing-customer-engagement-apps)
...
## [Learn the business value of Microsoft Dynamics 365 and the Power Platform](https://docs.microsoft.com/hu-hu/learn/paths/learn-business-value-of-dynamics-365-and-power-platform)
...
## [Get started with Dynamics 365 for Finance and Operations](https://docs.microsoft.com/hu-hu/learn/paths/get-started-finance-operations)
