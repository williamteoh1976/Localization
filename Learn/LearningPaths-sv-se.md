...
#### Inlärningsväg - 5 h 56 min - 6 Moduler
...
Med Azure DevOps kan du skapa, testa och distribuera valfritt program till valfritt moln eller lokalt. Lär dig hur du konfigurerar bygg-pipelines för att kontinuerligt skapa, testa och verifiera dina program.
I den här utbildningsvägen kommer du att göra följande:

samarbeta med andra för att skapa dina program med hjälp av Azure Pipelines och GitHub
köra automatiska tester i din pipeline för att verifiera kodkvaliteten
söka i källkoden och komponenter från tredje part efter potentiella säkerhetsproblem
definiera flera pipelines som fungerar tillsammans för att skapa programmet
skapa program med hjälp av både agenter som Microsoft-värdtjänst och dina egna build-agenter.
...
I den här utbildningsvägen påbörjar du din DevOps-resa. Du kommer att:

upptäcka hur värdeströmskartor kan hjälpa dig att utvärdera dina nuvarande processer och tekniker
registrera dig för ditt kostnadsfria Azure DevOps-konto
lära dig att planera och spåra arbetsobjekt med hjälp av Azure Boards.
...
#### Inlärningsväg - 8 h 40 min - 12 Moduler
...
#### Inlärningsväg - 8 h 26 min - 12 Moduler
...
#### Inlärningsväg - 2 h 9 min - 2 Moduler
...
#### Inlärningsväg - 41 min - 1 Moduler
...
#### Inlärningsväg - 8 h 27 min - 12 Moduler
...
Genom att använda dessa robotar kan kunderna interagera med datorprogram på ett konversationsbaserat sätt, till exempel via text, grafik eller tal. Det kan röra sig om en enkel dialog med frågor och svar eller en mer sofistikerad robot som gör att kunderna kan interagera med tjänsterna på ett intelligent sätt med hjälp av mönstermatchning, tillståndsspårning och tekniker med artificiell intelligens som integrerats med befintliga företagstjänster.  Lär dig hur du skapar en chattrobot och lägger till intelligens genom att integrera QnA Maker och LUIS.
...
Microsoft Cognitive Services har funktioner för att aktivera taltjänster i dina program. Lär dig hur du omvandlar tal till text och identifierar specifika talare i dina program genom att integrera Cognitive Speech Services.
...
Maskininlärning är en viktig komponent i program som använder artificiell intelligens. Microsoft tillhandahåller Machine Learning Studio och Machine Learning Services som hjälper dig att dra nytta av färdiga modeller eller skapa egna anpassade maskininlärningsmodeller. Lär dig hur du skapar ett konto för Azure Machine Learning Studio, hur du skapar ett exempelexperiment och hur du sedan publicerar och distribuerar det för användning som en webbtjänst.
...
Lär dig hur du använder Azure Databricks för att påskynda installationen av Databricks i Azure. Du kommer att arbeta med data i Azure SQL Data Warehouse med de inbyggda anslutningstjänsterna. Utforska de datatjänster som är tillgängliga med Azure Data Factory. Skapa enhetliga arbetsflöden och arbeta med den interaktiva analysarbetsytan som drivs av Apache Spark.
...
Är du intresserad av att lära dig mer om molnet på ett enkelt sätt? Eller är du kanske osäker på var du ska börja när det gäller molnteknik?
Den här utbildningsvägen tar dig med på en resa som börjar med att visa dig hur digital omvandling och molnets kraft kan omvandla din verksamhet. Vi beskriver t.e.x. hur Microsoft Azure-molntjänster kan stärka din organisation på en betrodd molnplattform. Slutligen visar vi hur du kan göra för att förverkliga denna resa i din organisation.
I den här utbildningsvägen får du hjälp med att:

förverkliga den digitala omvandlingen
identifiera sätt att migrera och modernisera program
få fram insikter genom data, artificiell intelligens (AI) och Sakernas Internet (IoT)
uppfylla en stor mängd standarder för regelefterlevnad på en betrodd molnplattform.
...
På den här utbildningsvägen kommer du att göra följande:

Lär dig hur du skapar ett Azure SQL Data Warehouse
Skicka frågor och visualisera data från Azure SQL Data Warehouse
Importera data till Azure SQL Data Warehouse med Polybase
Förstå säkerhetskontrollerna som tillhandahålls av Azure Storage och Azure SQL Data Warehouse
...
Lära dig om molnbegrepp som hög tillgänglighet, skalbarhet, elasticitet, feltolerans och haveriberedskap
Förstå fördelarna med molnbaserad databehandling i Azure och hur det kan spara tid och pengar
Jämföra grundläggande strategier för övergången till Azure-molnet
Utforska bredden av tjänster som är tillgängliga i Azure, inklusive beräkning, nätverk, lagring och säkerhet

När du har slutfört den här utbildningsvägen har du de kunskaper som krävs för att klara provet AZ900 om grunderna för Microsoft Azure.
...
## [Identify guiding principles for responsible AI in government](https://docs.microsoft.com/sv-se/learn/paths/responsible-ai-government-principles)
...
## [Get started with Trade in Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/sv-se/learn/modules/trade-get-started-dynamics-365-business-central)
...
## [Prepare to complete the Project Specialist Technical Achievement](https://docs.microsoft.com/sv-se/learn/paths/project-specialist-technical-achievement)
...
## [Get started with Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/sv-se/learn/paths/get-started-dynamics-365-business-central)
...
## [Process VAT in Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/sv-se/learn/paths/process-vat-dynamics-365-business-central)
...
## [Process customer and vendor payments in Microsoft Dynamics 365 Business Central](https://docs.microsoft.com/sv-se/learn/paths/process-customer-vendor-payments-dynamics-365-business-central)
...
## [Building Dynamics 365 for Finance and Operations](https://docs.microsoft.com/sv-se/learn/paths/build-finance-operations)
...
## [AI business school for education](https://docs.microsoft.com/sv-se/learn/paths/ai-business-school-education)
...
## [Configure and use the General ledger in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/sv-se/learn/paths/configure-use-general-ledger-dyn365-finance)
...
## [Work with accounts payable in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/sv-se/learn/paths/work-accounts-payable-dyn365-finance)
...
## [Apply goal management to Microsoft Dynamics 365 for Customer Engagement](https://docs.microsoft.com/sv-se/learn/paths/apply-goal-management-dynamics-365)
#### Learning Path - 1 h 20 min - 2 Modules
...
## [Working with Connected Field Service for Dynamics 365 and Azure IoT](https://docs.microsoft.com/sv-se/learn/paths/working-with-connected-field-service-iot)
...
## [Get started with Dynamics 365 for Finance and Operations](https://docs.microsoft.com/sv-se/learn/paths/get-started-finance-operations)
