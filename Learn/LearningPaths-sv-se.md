...
- Fjärrövervakning och service av kundens utrustning med Connected Field Service for Dynamics 365 och Azure IoT
- Registrera och hantera kundenheter med Connected Field Service for Dynamics 365 och Azure IoT
- Använda IoT Central med Connected Field Service for Dynamics 365
- Identifiera undantag med Connected Field Service for Dynamics 365 och Azure IoT
...
- Använda kunskapsartiklar för lösning av ärenden i Dynamics 365 for Customer Service
...
- Hantera ärenden med Microsoft Dynamics 365 for Customer Service
- Använd Microsoft Dynamics 365 for Customer Service köer för att hantera ärenden
...
- Alternativ för svarscirkulering och poängsättning av undersökningar i Kundröst (VoC) för Dynamics 365
- Hantera och aktivera åtgärder med hjälp av undersökningssvar i Kundröst (VoC) för Dynamics 365
...
## [Configure and manage fixed assets in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/sv-se/learn/paths/configure-manage-fixed-assets-d365-finance-ops)
...
## [Configure and use budgeting in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/sv-se/learn/paths/configure-use-budgeting-d365-finance-ops)
...
## [Configure and use the General ledger in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/sv-se/learn/paths/configure-use-general-ledger-dynamics-365-finance-ops)
...
## [Work with accounts payable in Dynamics 365 for Finance and Operations](https://docs.microsoft.com/sv-se/learn/paths/work-with-accounts-payable-in-dynamics-365-for-finance-and-ops)
...
## [Use Lifecycle Services (LCS) to design and plan an implementation of Dynamics 365 for Finance and Operations](https://docs.microsoft.com/sv-se/learn/paths/use-lcs-to-design-and-plan-an-implementation-of-f-and-o)
...
## [Implementing Dynamics 365 Customer Engagement Online](https://docs.microsoft.com/sv-se/learn/paths/implementing-customer-engagement-online)
