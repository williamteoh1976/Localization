...
Эта схема обучения познакомит вас с созданием приложения PowerApps, управляемого моделью, которое использует Common Data Service для приложений.
...
## [Обработка данных в большом объеме с Azure Data Lake Storage G2](https://docs.microsoft.com/ru-ru/learn/paths/data-processing-with-azure-adls)
...
#### Схема обучения - 9 ч 25 мин - 10 модулей
...
#### Схема обучения - 3 ч 0 мин - 3 модулей
...
## [Modern data warehouse](https://docs.microsoft.com/ru-ru/learn/paths/modern-data-warehouse)
#### Схема обучения - 14 ч 34 мин - 9 модулей
...
#### Схема обучения - 2 ч 0 мин - 2 модулей
...
## [Data science](https://docs.microsoft.com/ru-ru/learn/paths/data-science)
#### Схема обучения - 4 ч 53 мин - 5 модулей
