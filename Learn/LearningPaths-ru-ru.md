...
## [](https://docs.microsoft.com/ru-ru/learn/paths/dyn-power-plat-bus-app-fundamentals)
####  -  - 
...
#### Схема обучения - 4 ч 29 мин - Число модулей: 5
...
## [Use basic formulas to make better PowerApps canvas apps](https://docs.microsoft.com/ru-ru/learn/paths/use-basic-formulas-powerapps-canvas-app)
...
## [Work with data in a PowerApps canvas app](https://docs.microsoft.com/ru-ru/learn/paths/work-with-data-in-a-canvas-app)
...
## [Get started with Machine Learning with an Azure Data Science Virtual Machine](https://docs.microsoft.com/ru-ru/learn/paths/get-started-with-azure-dsvm)
#### Схема обучения - 1 ч 20 мин - Число модулей: 3
...
## [Build AI solutions with Azure Machine Learning service](https://docs.microsoft.com/ru-ru/learn/paths/build-ai-solutions-with-azure-ml-service)
#### Схема обучения - 2 ч 50 мин - Число модулей: 4
...
## [Explore AI solution development with data science services in Azure](https://docs.microsoft.com/ru-ru/learn/paths/explore-data-science-tools-in-azure)
...
## [Introduction to machine learning with Python and Azure Notebooks](https://docs.microsoft.com/ru-ru/learn/paths/intro-to-ml-with-python)
...
## [Administer containers in Azure](https://docs.microsoft.com/ru-ru/learn/paths/administer-containers-in-azure)
#### Схема обучения - 1 ч 37 мин - Число модулей: 2
...
## [Process and translate speech with Azure Cognitive Speech Services](https://docs.microsoft.com/ru-ru/learn/paths/translate-speech-with-speech-services)
...
## [Evaluate text with Azure Cognitive Language Services](https://docs.microsoft.com/ru-ru/learn/paths/evaluate-text-with-language-services)
...
## [Create Intelligent Bots with the Azure Bot Service](https://docs.microsoft.com/ru-ru/learn/paths/create-bots-with-the-azure-bot-service)
...
## [Process and classify images with the Azure Cognitive Vision Services](https://docs.microsoft.com/ru-ru/learn/paths/classify-images-with-vision-services)
...
## [Publish a Machine Learning Experiment with Microsoft Azure Machine Learning Studio](https://docs.microsoft.com/ru-ru/learn/paths/publish-experiment-with-ml-studio)
...
## [Perform data Engineering with Azure Databricks](https://docs.microsoft.com/ru-ru/learn/paths/modern-data-warehouse)
...
## [Automate a business process using Microsoft Flow](https://docs.microsoft.com/ru-ru/learn/paths/automate-process-using-flow)
...
## [Create and use analytics reports with Power BI](https://docs.microsoft.com/ru-ru/learn/paths/create-use-analytics-reports-power-bi)
...
## [Create a model-driven application in PowerApps](https://docs.microsoft.com/ru-ru/learn/paths/create-app-models-business-processes)
#### Схема обучения - 1 ч 40 мин - Число модулей: 2
This learning path introduces you to creating a model-driven PowerApp that uses the Common Data Service for Apps.

## [Create a canvas app in PowerApps](https://docs.microsoft.com/ru-ru/learn/paths/create-powerapps)
#### Схема обучения - 2 ч 16 мин - Число модулей: 3
...
## [Implement a Data Warehouse with Azure SQL Data Warehouse](https://docs.microsoft.com/ru-ru/learn/paths/implement-sql-data-warehouse)
...
## [Extract knowledge and insights from your data with Azure Databricks](https://docs.microsoft.com/ru-ru/learn/paths/data-science)
#### Схема обучения - 4 ч 38 мин - Число модулей: 5
...
## [Implement a Data Streaming Solution with Azure Streaming Analytics](https://docs.microsoft.com/ru-ru/learn/paths/implement-data-streaming-with-asa)
...
#### Схема обучения - 4 ч 46 мин - Число модулей: 15
...
## [Azure for the Data Engineer](https://docs.microsoft.com/ru-ru/learn/paths/azure-for-the-data-engineer)
...
## [Large Scale Data Processing with Azure Data Lake Storage Gen2](https://docs.microsoft.com/ru-ru/learn/paths/data-processing-with-azure-adls)
#### Схема обучения - 2 ч 5 мин - Число модулей: 3
...
## [Azure fundamentals](https://docs.microsoft.com/ru-ru/learn/paths/azure-fundamentals)
...
## [Develop Windows 10 applications](https://docs.microsoft.com/ru-ru/learn/paths/develop-windows10-apps)
#### Схема обучения - 4 ч 30 мин - Число модулей: 4
Learn how to develop, test, and deploy Windows 10 applications.

## [Administer infrastructure resources in Azure](https://docs.microsoft.com/ru-ru/learn/paths/administer-infrastructure-resources-in-azure)
#### Схема обучения - 9 ч 29 мин - Число модулей: 10
Learn how to create, manage, secure and scale virtual machine resources.

## [Deploy a website to Azure with Azure App Service](https://docs.microsoft.com/ru-ru/learn/paths/deploy-a-website-with-azure-app-service)
#### Схема обучения - 3 ч - Число модулей: 3
...
## [Work with NoSQL data in Azure Cosmos DB](https://docs.microsoft.com/ru-ru/learn/paths/work-with-nosql-data-in-azure-cosmos-db)
#### Схема обучения - 2 ч 27 мин - Число модулей: 4
...
## [Manage resources in Azure](https://docs.microsoft.com/ru-ru/learn/paths/manage-resources-in-azure)
#### Схема обучения - 3 ч 29 мин - Число модулей: 4
Learn how to work with the Azure command line and web portal to create, manage, and control cloud based resources.

## [Create serverless applications](https://docs.microsoft.com/ru-ru/learn/paths/create-serverless-applications)
...
## [Work with relational data in Azure](https://docs.microsoft.com/ru-ru/learn/paths/work-with-relational-data-in-azure)
#### Схема обучения - 1 ч 34 мин - Число модулей: 2
...
## [Secure your cloud data](https://docs.microsoft.com/ru-ru/learn/paths/secure-your-cloud-data)
...
## [Architect great solutions in Azure](https://docs.microsoft.com/ru-ru/learn/paths/architect-great-solutions-in-azure)
...
## [Connect your services together](https://docs.microsoft.com/ru-ru/learn/paths/connect-your-services-together)
#### Схема обучения - 3 ч 33 мин - Число модулей: 4
...
## [Deploy a website with Azure virtual machines](https://docs.microsoft.com/ru-ru/learn/paths/deploy-a-website-with-azure-virtual-machines)
#### Схема обучения - 4 ч 13 мин - Число модулей: 4
...
## [Store data in Azure](https://docs.microsoft.com/ru-ru/learn/paths/store-data-in-azure)
